...
public class SilverGeneralTests {
    ...
    public class MockBoardB extends Board
    {
        ...
        public void initializeBoard(){
            MockBoardB[0][0] = new SilverGeneral(0, 0, true);
            MockBoardB[8][8] = new SilverGeneral(8, 8, true);

            MockBoardB[2][4] = new SilverGeneral(2, 4, true);
            MockBoardB[5][4] = new SilverGeneral(5, 4, true);

            MockBoardB[6][5] = new Pawn(6, 5, false);
            MockBoardB[5][5] = new Pawn(5, 5, true);
        }
        public Piece getPiece(int x, int y) {
    ...
    void testIsValidMoveSG(){
        ...
        assertFalse(sg_24.isValidMove(1, 2, taulell_aux_w.MockBoardW), "permet moviments dobles");
        ...
        Piece sg_88B = taulell_aux_w.getPiece(8,8);
        ...
        Piece sg_24B = taulell_aux_w.getPiece(2,4);
        assertTrue(sg_24B.isValidMove(2, 5, taulell_aux_b.MockBoardB), "no permet moviment correcte");
        assertTrue(sg_24B.isValidMove(3, 5, taulell_aux_b.MockBoardB), "no permet moviment correcte");
        ...
        Piece sg_54B = taulell_aux_w.getPiece(5,4);
